...
docker run --rm --entrypoint node "${image}" -e \
  "require('/opt/wasm-game-framework/server/lifecycle.js'); require('/opt/wasm-game-framework/server/password-auth.js'); require('/opt/wasm-game-framework/server/media-library.js'); require('/opt/wasm-game-framework/server/provisioning.js'); require('/opt/wasm-game-framework/dist/wasm-game-framework.js')"
